...
<html lang="zxx">
<head>
<title>ETV Plateforme</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="ETV web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> ETV</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In now</a> </li>
				...
				<form  method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-calendar" aria-hidden="true"></i><input class="date" id="datepicker" name="date" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="" /></li>
							...
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="namefather" type="text" required=""></li>
					</ul>
					</div>
					<div class="col-md-6 col-xs-6 w3l-right-mk">
						<ul>
							<li class="text">Email  :  </li>
							<li class="agileits-main"><i class="fa fa-phone" aria-hidden="true"></i><input name="email" type="text" required=""></li>
							...
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="namemother" type="text" required=""></li>

						</ul>
					</div>
					<div class="clearfix"></div>
					<div class="agile-submit">
						<input type="submit" name="add_demande_inscri" value="Inscription">
					</div>
				</form>
			</div>
		</div>
...
<div class="about-top" id="about">
	<div class="container">
		...
		<div class="col-md-5 wthree-about-grids">
			<h4>Welcome to Our Online School</h4>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<h6>01</h6>
				<h5>ETV System</h5>
				<p>Our Platefrome composed of a helpful system for online management and school process .</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Skilled Students</h5>
				<p>Our students are enable to get a lot of skills which make them in a good situation.</p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<h6>03</h6>
				<h5>Best Program</h5>
				<p>Our School learning program is the first on the national road map</p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
	...
	<div class="container">
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Address</h4>
					<p><?php echo "Our Business Address"; ?> <span><?php echo "Iset Sousse"; ?></p>
					<p></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p><?php echo "Our Phone Number"; ?> <span><?php echo "+21612345678"; ?></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				<div class="agile_contact_grid_left agileits_w3layouts_left1">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"><?php echo "Our Email"; ?></a>
						<span><a href="mailto:info@example.com"><?php echo "ETV@admin.com"; ?></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com"><?php echo "ETV@admin.com" ?></a></li>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>©  - 2021 ETV. All rights reserved | Design by <a href="">ETV SCHOOL.</a> Developed By Mghirbi Mohamed Amine</p>
	</div>
</div>
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(35.80199530512057, 10.614252037535485),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(35.80199530512057, 10.614252037535485),
						map: map,
					});
				}
			</script>
